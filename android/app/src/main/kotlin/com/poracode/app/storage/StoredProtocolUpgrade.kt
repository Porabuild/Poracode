...
internal object StoredProtocolUpgrade {
    ...
    // v10/v11 changed wire content, not stored credential identity.
    fun isEligibleStoredProtocol(version: Int?): Boolean =
        version == PREVIOUS_VERSION || version == 10 || version == 11

    fun importedBinding(version: Int): Int? = when (version) {
        0 -> ProtocolConstants.REMOTE_PROTOCOL_VERSION
        PREVIOUS_VERSION, 10, 11, ProtocolConstants.REMOTE_PROTOCOL_VERSION -> version
        else -> null
    }
}
