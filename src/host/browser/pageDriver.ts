/** Narrow page-execution seam. Both the embedded browser's `WebContents` and
 *  the external Chrome adapter's `executeJavaScript` satisfy it structurally,
 *  so this driver stays Electron-free. */
export interface PageJavaScriptExecutor {
  executeJavaScript(code: string, userGesture?: boolean): Promise<unknown>;
}

type PageExecutor = PageJavaScriptExecutor;
