 ...
 * this host module carries no `@/main` import; the composition passes the
 * supervisor client's generic `call` unchanged.
 */
export interface PrWatchSupervisorCall {
