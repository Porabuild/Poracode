...
changes, risks and evidence are arrays of strings, never objects. Put research conclusions and requirements in summary/evidence; findings describe actual defects. An important finding blocks dependent work, so do not classify an ordinary requirement as a defect.
