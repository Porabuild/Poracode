...
export function createSupervisorIpcHandlers(runtime: SupervisorRuntime): SupervisorIpcHandlerMap {
  return defineSupervisorIpcHandlers({
    ...
    scanSkills: (payload) => runtime.scanSkills(payload),
    readSkill: (payload) => runtime.readSkill(payload),
    writeSkill: (payload) => runtime.writeSkill(payload),
    createSkill: (payload) => runtime.createSkill(payload),
    deleteSkill: (payload) => runtime.deleteSkill(payload),
    renameSkill: (payload) => runtime.renameSkill(payload),
    transferSkill: (payload) => runtime.transferSkill(payload),
    optimizeSkills: (payload) => runtime.optimizeSkills(payload),
    installMarketplaceSkill: (payload) => runtime.installMarketplaceSkill(payload),
    installSkillFromGit: (payload) => runtime.installSkillFromGit(payload),
