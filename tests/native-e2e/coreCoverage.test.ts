...
describe("native real-socket core coverage profile", () => {
  ...
  it("positively exercises the complete 201-operation remote-v3 inventory", async () => {
    ...
    expect(snapshot.counts).toEqual({
      route: { expected: 56, positive: 56, unsupported: 0, missing: 0 },
      ...
      replay: { expected: 14, positive: 14, unsupported: 0, missing: 0 },
