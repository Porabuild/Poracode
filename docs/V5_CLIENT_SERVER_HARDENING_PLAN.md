...
| ---------- | ----- | ------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-18 | 0     | 0.1–0.4 | _(this commit)_ | Attached-Electron caps corrected (+test); project-settings MCP read redacted with write-side marker restore (+route and command tests); startup failure dialog with Retry via shared message catalog (+test, 12 locales); Gate 2 row amended. Typecheck/lint green; 144 focused tests pass. |
