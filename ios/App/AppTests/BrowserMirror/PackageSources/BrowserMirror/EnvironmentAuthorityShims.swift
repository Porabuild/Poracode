...
// graph that the symlinked browser-mirror sources adopt:
...
// definitions when they change. BrowserMirror package compilation and transport tests pin that contract.
//
...
/// Mirror of the app client error (`RemoteModels.swift`). The browser-mirror
