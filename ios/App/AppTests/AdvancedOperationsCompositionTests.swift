  ...
  func testSessionIdentityIsStableForOneSessionAndDistinctAcrossHosts() {
    ...
    for variant in [
      AdvancedOperationsSessionIdentity.make(
        ...
        endpoint: "https://desktop.test", protocolVersion: ProtocolConstants.remoteProtocolVersion, generation: 4),
      AdvancedOperationsSessionIdentity.make(
        connectionID: connectionID, desktopID: "other",
        endpoint: "https://desktop.test", protocolVersion: ProtocolConstants.remoteProtocolVersion, generation: 4),
      AdvancedOperationsSessionIdentity.make(
        connectionID: connectionID, desktopID: "desktop",
        endpoint: "https://other.test", protocolVersion: ProtocolConstants.remoteProtocolVersion, generation: 4),
      AdvancedOperationsSessionIdentity.make(
        connectionID: connectionID, desktopID: "desktop",
        endpoint: "https://desktop.test", protocolVersion: ProtocolConstants.remoteProtocolVersion, generation: 5),
    ] {
