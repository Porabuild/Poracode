...
import Foundation
public struct ProceduredbGetThreadContextUsageResultU2DOptionU2D1_125fbdbcb6: Codable, Sendable, RemoteModelMetadata {
  public var breakdown: RemoteField<[ProceduredbGetThreadContextUsageResultU2DOptionU2D1U2DBreakdownU2DItem_1b3dc298a6]> = .missing
  ...
  public static let fields: [RemoteFieldDescriptor] = [
    .init(wireName: "breakdown", typeName: "[ProceduredbGetThreadContextUsageResultU2DOptionU2D1U2DBreakdownU2DItem_1b3dc298a6]", required: false, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.breakdown = try container.decode(RemoteField<[ProceduredbGetThreadContextUsageResultU2DOptionU2D1U2DBreakdownU2DItem_1b3dc298a6]>.self, forKey: .breakdown)
    self.maxTokens = try container.decode(RemoteField<Int64>.self, forKey: .maxTokens)
    self.usedTokens = try container.decode(RemoteField<Int64>.self, forKey: .usedTokens)
  }
...
public typealias ProceduredbGetThreadContextUsageResult_75e84dcbf2 = ProceduredbGetThreadContextUsageResultU2DOptionU2D1_125fbdbcb6?

public typealias ProceduredbGetThreadRuntimeItemsResult_d3749f0d30 = [ProceduredbGetLatestThreadGoalItemResultU2DOptionU2D1_4c1171296b]

public struct ProceduredbGetThreadsPageRequest_a22ec4f35f: Codable, Sendable, RemoteModelMetadata {
  public var cursor: RemoteField<String> = .missing
  public var limit: Int64
  public var projectId: RemoteField<String> = .missing
  public static let unknownFieldPolicy: RemoteUnknownFieldPolicy = .strip
  public static let fields: [RemoteFieldDescriptor] = [
    .init(wireName: "cursor", typeName: "String", required: false, nullable: false, minimum: nil, maximum: nil, minLength: 1, maxLength: 256, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
    ...
    .init(wireName: "projectId", typeName: "String", required: false, nullable: false, minimum: nil, maximum: nil, minLength: 1, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
  ]
  public static let semanticValidatorIds: [String] = []
  private enum CodingKeys: String, CodingKey {
    case cursor = "cursor"
...
public enum ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DAttention_58edfaf9f7: String, Codable, Sendable {
  case none = "none"
...
public struct ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DConfig_a4dfd32571: Codable, Sendable, RemoteModelMetadata {
...
public enum ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DPresentationMode_6508684ba6: String, Codable, Sendable {
  case terminal = "terminal"
  case gui = "gui"
}

public struct ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DSessionRef_3b70e9f118: Codable, Sendable, RemoteModelMetadata {
...
public enum ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DSlashCommandsU2DItemU2DSection_f4cab1817a: String, Codable, Sendable {
  case skills = "skills"
}

public enum ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DSlashCommandsU2DItemU2DSkillScope_ac6ea0fc11: String, Codable, Sendable {
  case global = "global"
  case project = "project"
}

public struct ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DSlashCommandsU2DItem_7324613e41: Codable, Sendable, RemoteModelMetadata {
  ...
  public var section: RemoteField<ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DSlashCommandsU2DItemU2DSection_f4cab1817a> = .missing
  ...
  public var skillScope: RemoteField<ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DSlashCommandsU2DItemU2DSkillScope_ac6ea0fc11> = .missing
  public static let unknownFieldPolicy: RemoteUnknownFieldPolicy = .strip
  public static let fields: [RemoteFieldDescriptor] = [
    ...
    .init(wireName: "section", typeName: "ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DSlashCommandsU2DItemU2DSection_f4cab1817a", required: false, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
    ...
    .init(wireName: "skillScope", typeName: "ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DSlashCommandsU2DItemU2DSkillScope_ac6ea0fc11", required: false, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
  ]
  public static let semanticValidatorIds: [String] = []
  private enum CodingKeys: String, CodingKey {
...
public enum ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DStatus_8c61ed237d: String, Codable, Sendable {
...
public enum ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DThreadStatusSource_8f73948792: String, Codable, Sendable {
  case cliU5FHook = "cli_hook"
  case terminalU5FParse = "terminal_parse"
  case server = "server"
}

public struct ProceduredbGetThreadsPageResultU2DThreadsU2DItem_227a23596a: Codable, Sendable, RemoteModelMetadata {
  ...
  public var config: ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DConfig_a4dfd32571
  ...
  public static let fields: [RemoteFieldDescriptor] = [
    ...
    .init(wireName: "config", typeName: "ProceduredbGetThreadsPageResultU2DThreadsU2DItemU2DConfig_a4dfd32571", required: true, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
...
public struct ProceduredbGetThreadsPageResult_3b31fe417e: Codable, Sendable, RemoteModelMetadata {
  ...
  public var threads: [ProceduredbGetThreadsPageResultU2DThreadsU2DItem_227a23596a]
  public static let unknownFieldPolicy: RemoteUnknownFieldPolicy = .strip
  public static let fields: [RemoteFieldDescriptor] = [
    ...
    .init(wireName: "threads", typeName: "[ProceduredbGetThreadsPageResultU2DThreadsU2DItem_227a23596a]", required: true, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
  ]
  public static let semanticValidatorIds: [String] = []
  private enum CodingKeys: String, CodingKey {
...
public struct ProceduredbReplaceThreadCompletedTurnsRequest_2798a86525: Codable, Sendable, RemoteModelMetadata {
  public var threadId: String
  public var turns: ProceduredbGetThreadCompletedTurnsResult_4c20b50150
  public static let unknownFieldPolicy: RemoteUnknownFieldPolicy = .strip
  public static let fields: [RemoteFieldDescriptor] = [
    .init(wireName: "threadId", typeName: "String", required: true, nullable: false, minimum: nil, maximum: nil, minLength: 1, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
    .init(wireName: "turns", typeName: "ProceduredbGetThreadCompletedTurnsResult_4c20b50150", required: true, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
  ]
  public static let semanticValidatorIds: [String] = []
  private enum CodingKeys: String, CodingKey {
...
public struct ProceduredbReplaceThreadRuntimeItemsRequest_a87ba81107: Codable, Sendable, RemoteModelMetadata {
...
public struct ProceduredbReplaceThreadRuntimeSnapshotRequestU2DContextUsageU2DOptionU2D1_80ac3a097b: Codable, Sendable, RemoteModelMetadata {
  public var breakdown: RemoteField<[ProceduredbGetThreadContextUsageResultU2DOptionU2D1U2DBreakdownU2DItem_1b3dc298a6]> = .missing
  public var maxTokens: RemoteField<Int64> = .missing
  public var usedTokens: RemoteField<Int64> = .missing
  public static let unknownFieldPolicy: RemoteUnknownFieldPolicy = .strip
...
public typealias ProceduredbReplaceThreadRuntimeSnapshotRequestU2DContextUsage_e47ad2358c = ProceduredbReplaceThreadRuntimeSnapshotRequestU2DContextUsageU2DOptionU2D1_80ac3a097b?

public struct ProceduredbReplaceThreadRuntimeSnapshotRequest_a20d815ba5: Codable, Sendable, RemoteModelMetadata {
...
public struct ProceduredetectProjectIconRequest_5e3a19fb85: Codable, Sendable, RemoteModelMetadata {
  public var projectLocation: ProcedurebeginMcpServerOauthRequestU2DProjectLocation_080f9cc154
  public static let unknownFieldPolicy: RemoteUnknownFieldPolicy = .strip
  public static let fields: [RemoteFieldDescriptor] = [
    .init(wireName: "projectLocation", typeName: "ProcedurebeginMcpServerOauthRequestU2DProjectLocation_080f9cc154", required: true, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
