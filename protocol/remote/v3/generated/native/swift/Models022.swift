...
public struct RoutemetricsResponseU2DHostResourceAdmissionU2DGitProcessesU2DLong_da873100cb: Codable, Sendable, RemoteModelMetadata {
...
public struct RoutemetricsResponseU2DHostResourceAdmissionU2DGitProcesses_1146a35688: Codable, Sendable, RemoteModelMetadata {
  public var admitted: Int64
  public var cancellations: Int64
  public var long: RoutemetricsResponseU2DHostResourceAdmissionU2DGitProcessesU2DLong_da873100cb
  public var queueFullRefusals: Int64
  public var short: RoutemetricsResponseU2DHostResourceAdmissionU2DGitProcessesU2DLong_da873100cb
  ...
  public static let fields: [RemoteFieldDescriptor] = [
    ...
    .init(wireName: "long", typeName: "RoutemetricsResponseU2DHostResourceAdmissionU2DGitProcessesU2DLong_da873100cb", required: true, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
    ...
    .init(wireName: "short", typeName: "RoutemetricsResponseU2DHostResourceAdmissionU2DGitProcessesU2DLong_da873100cb", required: true, nullable: false, minimum: nil, maximum: nil, minLength: nil, maxLength: nil, minItems: nil, maxItems: nil, pattern: nil, format: nil, semanticValidatorIds: []),
