...
data class RouteschedulesU2DCommandRequestU2DOptionU2D1U2DTask_aa2e4a946a(
    ...
    @SerialName("config") val config: RouteprU2DWatchU2DReadResponseU2DWatchU2DOptionU2D1U2DConfig_048d1517dd,
    ...
    companion object {
        val descriptor = RemoteModelDescriptor(RemoteUnknownFieldPolicy.STRIP, listOf(
            ...
            RemoteFieldDescriptor("config", "RouteprU2DWatchU2DReadResponseU2DWatchU2DOptionU2D1U2DConfig_048d1517dd", true, false, null, null, null, null, null, null, null, null, listOf()),
...
typealias RouteschedulesU2DCommandResponseU2DScheduleU2DLastCompletedAt_01f7df3e67 = String?
...
@Serializable
data class RoutesettingsU2DReadResponseU2DSettings_cd1cd5717f(
...
@Serializable
data class RoutesettingsU2DReadResponse_b650487ee1(
    @SerialName("settings") val settings: RoutesettingsU2DReadResponseU2DSettings_cd1cd5717f,
) {
    companion object {
        val descriptor = RemoteModelDescriptor(RemoteUnknownFieldPolicy.STRIP, listOf(
            RemoteFieldDescriptor("settings", "RoutesettingsU2DReadResponseU2DSettings_cd1cd5717f", true, false, null, null, null, null, null, null, null, null, listOf()),
        ), listOf())
    }
}
