...
internal val schema_2101176bb1edeca8: RemoteSchema by lazy {
    RemoteSchema(type = "object", required = setOf("projectLocation", "runId"), properties = mapOf("projectLocation" to schema_080f9cc154af9e27, "runId" to schema_f58a8b771657d037), additionalAllowed = true, unknownPolicy = RemoteUnknownFieldPolicy.STRIP)
}
...
internal val schema_23a952c095175515: RemoteSchema by lazy {
    RemoteSchema(type = "object", required = setOf("projectLocation"), properties = mapOf("projectLocation" to schema_080f9cc154af9e27, "workflowId" to schema_f58a8b771657d037), additionalAllowed = true, unknownPolicy = RemoteUnknownFieldPolicy.STRIP)
}
...
internal val schema_257f5640a130bf26: RemoteSchema by lazy {
    RemoteSchema(type = "object", required = setOf("numTurns", "threadId"), properties = mapOf("config" to schema_03b0262a8a76c7b7, "numTurns" to schema_56aa0e45cbdce0d0, "threadId" to schema_36fea325bf1aca70), additionalAllowed = true, unknownPolicy = RemoteUnknownFieldPolicy.STRIP)
}
...
internal val schema_28571b7aa62ce1e4: RemoteSchema by lazy {
    RemoteSchema(type = "object", additionalSchema = schema_e1630d13dcde5529, propertyNames = schema_36fea325bf1aca70, unknownPolicy = RemoteUnknownFieldPolicy.STRIP)
}
...
internal val schema_2ad366bf61312387: RemoteSchema by lazy {
    RemoteSchema(type = "array", items = schema_936535b2f1c97eac, unknownPolicy = RemoteUnknownFieldPolicy.STRIP)
}
...
internal val schema_2c21c4a9623808ef: RemoteSchema by lazy {
    RemoteSchema(type = "object", required = setOf("id", "kind", "task"), properties = mapOf("id" to schema_d855999aed5e6438, "kind" to schema_cbc64d14585e9a92, "task" to schema_aa2e4a946a9060bf), additionalAllowed = true, unknownPolicy = RemoteUnknownFieldPolicy.STRIP)
}
...
internal val schema_3376a05db16d0c0b: RemoteSchema by lazy {
    RemoteSchema(unionKind = "oneOf", options = listOf(schema_b01e26e0438140cd, schema_6efd374b59679df0, schema_a656e9f9963686f0, schema_2e4d2aaed030369e, schema_c3363423bb669510, schema_80906c6ddc7c6c9e, schema_ebd70a208b453fe1, schema_b79d8f64de4f41bd, schema_09765c7778825d10, schema_431be1ab7e1b0dc9, schema_a93ba7bf23f9b121, schema_370ff0ec0af5649a), unknownPolicy = RemoteUnknownFieldPolicy.STRIP)
}
...
internal val schema_352050e671edc6e9: RemoteSchema by lazy {
    RemoteSchema(type = "object", properties = mapOf("disabled" to schema_feeb8bb50144d96d, "mcpServers" to schema_637f685cb2418b8c, "name" to schema_36fea325bf1aca70, "scripts" to schema_3155b0e8649e47af, "searchSettings" to schema_3e412d7b328b3f5a, "worktreeLocation" to schema_137e14636e0bc235), additionalAllowed = true, unknownPolicy = RemoteUnknownFieldPolicy.STRIP)
}
