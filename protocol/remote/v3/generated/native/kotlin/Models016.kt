...
@Serializable
enum class RouteprojectU2DCommandRequestU2DOptionU2D6U2DKind_034741cb26 {
    @SerialName("remove") REMOVE,
}

@Serializable
data class RouteprojectU2DCommandRequestU2DOptionU2D6_37addcca5b(
    @SerialName("kind") val kind: RouteprojectU2DCommandRequestU2DOptionU2D6U2DKind_034741cb26,
    @SerialName("projectId") val projectId: String,
) {
    companion object {
        val descriptor = RemoteModelDescriptor(RemoteUnknownFieldPolicy.STRIP, listOf(
            RemoteFieldDescriptor("kind", "RouteprojectU2DCommandRequestU2DOptionU2D6U2DKind_034741cb26", true, false, null, null, null, null, null, null, null, null, listOf()),
            RemoteFieldDescriptor("projectId", "String", true, false, null, null, 1, null, null, null, null, null, listOf()),
        ), listOf())
    }
}
...
@Serializable
data class RouteprojectU2DSettingsResponseU2DMcpServersU2DItem_d66267c393(
