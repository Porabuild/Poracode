...
const bundle = ensureSshRuntimeBundle({
  ...
  cacheDir: resolve(root, ".tmp/mobile-ssh-runtime-bundles"),
});
const outDir = resolve(root, "resources/mobile-ssh-runtime");
...
console.log(`[build-mobile-ssh-runtime] embedded ${bundle.hash}`);
